...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BFFcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"bffcointools.com", "188.166.182.144"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"bffcointools.com", "testnet-seed.bffcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BFFcoin is probably already running."), addrBind.ToString().c_str());
        else
